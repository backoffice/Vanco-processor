...
//Modified for Vanco processor - Set payment instrument as selected by user
		$this->assign('payment_method', $this->_params['payment_method']);
	 //Ends
...
//Modified by BOT for Vanco Payment processor
      if( $this->_paymentProcessor['class_name'] == 'vanco.directpayment.processor' ) {
           $paymentParams['contactID'] = $this->_contactID;
      }
	  //Ends

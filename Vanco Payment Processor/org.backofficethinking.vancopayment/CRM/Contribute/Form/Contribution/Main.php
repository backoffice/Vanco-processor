...
class CRM_Contribute_Form_Contribution_Main extends CRM_Contribute_Form_ContributionBase {
  ...
  public function buildQuickForm() {
	...
	if( $this->_values['custom_pre_id'] == 1 ){
		$this->add( 'checkbox', 'copy_home_address', 'Billing same as above', null, null, array('onClick' => 'copyAddress();') );
	}
  }
  ...
  public static function buildRecur(&$form) {
    ...
    if(sizeof($unitVals) == 1) {
	  ...
	  //Modified by BOT for Vanco
	  if( $form->_paymentProcessor['class_name'] ) {
		$frequencyUnits['biweek'] = 'biweek';
		$frequencyUnits['quarter'] = 'quarter';
	  }
